...
const generateReport = ({ sunrise, sunriseEnd, goldenHourEnd, goldenHour, solarNoon, sunsetStart, sunset, sunAtThirdMorning, sunAtThirdEvening, sunAtHalfMorning, sunAtHalfEvening, }) => `
  Here is your report!
    - Sunrise
      - TimeFrame: from ${getHourAndMinute(sunrise)} to ${getHourAndMinute(sunriseEnd)}
    ...
    - Sunset
      - Timeframe: from ${getHourAndMinute(sunsetStart)} to ${getHourAndMinute(sunset)}
